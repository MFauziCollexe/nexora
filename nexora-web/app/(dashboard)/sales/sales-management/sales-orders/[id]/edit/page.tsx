  ...
  return (
    <div className="px-4 py-5 sm:px-6">
      <div className="flex items-center gap-1.5 text-[11px] text-slate-400 dark:text-slate-500 mb-4">
        ...
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-3 h-3"><path d="M9 18l6-6-6-6"/></svg>
        <span className="text-slate-700 dark:text-slate-200 font-medium">Edit Sales Order</span>
      </div>

      <div className="flex items-center justify-between mb-5">
        <h1 className="text-xl font-semibold text-slate-800 dark:text-slate-100">Edit Sales Order #{params.id}</h1>
      ...
      <div className="rounded-sm border border-slate-200 dark:border-slate-700 bg-amber-50 dark:bg-amber-950 p-4 mb-5">
        <p className="text-[12px] text-amber-700 dark:text-amber-400">
          Edit mode for Sales Order #{params.id}. Pre-populated data will be available once the backend update functionality is connected.
        </p>
      </div>
